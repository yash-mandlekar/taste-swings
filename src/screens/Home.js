...
export default function Home() {
  ...
  const loadData = async () => {
    try {
      ...
      console.log(data?.items, data?.category);
      ...
      <div className="fs-4" style={{ width: "100%" }}>
        ...
        <div>
          <div
            ...
            className="carousel slide crousel-fade"
          ...
          >
            ...
            >
              ...
              <div className="carousel-item">
                <img
                  src="https://source.unsplash.com/random/300×700/?momos"
                  className="d-block w-100"
                  style={{
                    filter: "brigtness(0%)",
                    objectFit: "fill",
              ...
              <div className="carousel-item">
                <img
                  src="https://source.unsplash.com/random/300×700/?paneer"
                  className="d-block w-100"
                  style={{
                    filter: "brigtness(0%)",
                    objectFit: "fill",
